  ...
  return (
    <div className='max-w-7xl mx-auto my-10'>
        <div className='flex items-center justify-between'>
            ...
            <Button disabled={isApplied} className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allow': 'bg-[#7209b7] hover:bg-[#5f32ad]'}`}>
        ...
        <div>
            ...
            <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>17-02-2024</span> </h1>
